...
class NcLauncher(Launcher):
    ...
    def create_run_sh(self, full_path, cmd) -> None:
    ...
    def poll(self):
        ...
        if self.process.poll() is None:
            ...
            if run_timeout_mins is not None and not self.deploy.gui:
                ...
                if self.nc_job_state == "waiting":  # noqa: SIM102
                ...
                if self.nc_job_state == "running":  # noqa: SIM102
                ...
                if self.nc_job_state in {"wait_timeout", "run_timeout"}:
                    ...
                    if self.nc_job_state == "run_timeout":
                        timeout_message = f"Job timed out after running {run_timeout_mins} mins"
